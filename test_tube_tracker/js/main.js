...
<section id="racks-page" class="page">
    ...
    <div id="rack-list">
        <!-- Rack cards will be rendered here by RackManager -->
    </div>
    <!-- Rack Modal -->
        ...
        <div class="modal-content">
            ...
            <form id="rack-form">
                ...
                <div>
                    ...
                    <input type="text" id="rack-name" required>
                </div>
                <div>
                    <label for="rack-rows">Rows:</label>
                    <input type="number" id="rack-rows" min="1" required>
                </div>
                <div>
                    <label for="rack-cols">Columns:</label>
                    <input type="number" id="rack-cols" min="1" required>
                </div>
    ...
    <div id="history-log">
        <table>
            ...
            <tbody id="history-table-body">
                <!-- History entries rendered here by HistoryManager -->
            </tbody>
        </table>
    </div>
</section>
